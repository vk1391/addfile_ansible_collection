...
def run_module():
    ...
    module_args = dict(
        ...
        content=dict(type='str', required=False, default='Any_content')
    )
    ...
    if file_exist(module.params["path"]):
        ...
        result['changed'] = True
        result['original_message'] = 'file {path} succefully created'.format(path = module.params['path']) 
